...
export function Output({ output, err }: OutputProps): JSX.Element {
  if (err.length > 0) {
    return (
...
export function Loading({ message }: { message: string }): JSX.Element {
  return (
    <div className="bg-yellow-300">
      <pre className="bg-black text-yellow-300 rounded p-4">
        <svg aria-hidden="true" className="w-8 h-8 animate-spin dark:text-gray-600 fill-red-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
